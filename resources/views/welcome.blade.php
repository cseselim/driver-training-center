...
<body>
    <header
        ...
        <div class="relative mx-auto">
            <nav class="mx-auto mr-2 flex items-center justify-between px-2 py-4 md:mr-5 md:px-10 md:py-1 2xl:px-16">
                <div class="w-40 cursor-pointer px-2 md:w-44 lg:block lg:w-auto lg:px-0"><a href="/"><img alt="BDDTI Logo"
                                            width="100" height="35" decoding="async" data-nimg="1" src="{{ asset('asstes/image/logo/logo (1).png') }}"
                ...
                <div class="hidden flex-grow xl:block">
                    <ul class="flex items-center justify-center xl:gap-5 2xl:gap-10">
                        ...
                        <li class="group relative"><a
                                class="relative cursor-pointer px-[2px] py-1 font-inter text-[15px] tracking-wide transition-colors duration-300 ease-in-out dark:text-gray-300 font-medium text-gray-800 "
                                href="/driving-license">License<span
                                    class="absolute bottom-0 left-0 h-[3px] w-0 origin-left bg-gradient-to-r from-sky-100 via-sky-300 to-sky-500 transition-all duration-500 ease-out group-hover:w-full "
                                    style="background-size: 100% 100%; animation: auto ease 0s 1 normal none running none;"></span></a>
                        </li>
                        <li class="group relative"><a
                        ...
                        <li class="group relative"><a
                                class="relative cursor-pointer px-[2px] py-1 font-inter text-[15px] tracking-wide transition-colors duration-300 ease-in-out dark:text-gray-300 font-medium text-gray-800 "
                                href="/branches">Our Branches<span
                                    class="absolute bottom-0 left-0 h-[3px] w-0 origin-left bg-gradient-to-r from-sky-100 via-sky-300 to-sky-500 transition-all duration-500 ease-out group-hover:w-full "
                                    style="background-size: 100% 100%; animation: auto ease 0s 1 normal none running none;"></span></a>
                        </li>
                        <li class="group relative"><a
                ...
                <div class="flex items-center"><button aria-label="Toggle Dark Mode"
                        class="rounded p-2 text-gray-800 transition xl:mr-5"><svg stroke="currentColor" fill="currentColor"
                            stroke-width="0" viewBox="0 0 16 16" class="text-xl text-blue-500 transition-all duration-300"
            ...
            <div class="relative z-10"><button id="cart-icon"
                    class="absolute right-5 top-4 flex cursor-pointer items-center justify-start rounded-full bg-white p-2 shadow-xl md:right-[50px] md:top-10 xl:-top-[44px] xl:right-[60px] xl:bg-transparent xl:p-0 xl:shadow-none 2xl:right-[85px]"><span
                        class="relative text-3xl text-orange-600"><svg stroke="currentColor" fill="currentColor"
                            stroke-width="0" viewBox="0 0 576 512" class="block lg:hidden" height="24" width="24"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                            ...
                            class="hidden lg:block" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M528.12 301.319l47.273-208C578.806 78.301 567.391 64 551.99 64H159.208l-9.166-44.81C147.758 8.021 137.93 0 126.529 0H24C10.745 0 0 10.745 0 24v16c0 13.255 10.745 24 24 24h69.883l70.248 343.435C147.325 417.1 136 435.222 136 456c0 30.928 25.072 56 56 56s56-25.072 56-56c0-15.674-6.447-29.835-16.824-40h209.647C430.447 426.165 424 440.326 424 456c0 30.928 25.072 56 56 56s56-25.072 56-56c0-22.172-12.888-41.332-31.579-50.405l5.517-24.276c3.413-15.018-8.002-29.319-23.403-29.319H218.117l-6.545-32h293.145c11.206 0 20.92-7.754 23.403-18.681z">
                            </path>
                        </svg><span
    ...
    ">
        <div class="absolute inset-0 -z-10 bg-[#0359A9] dark:bg-gray-900"><img alt="Hero background" decoding="async"
                data-nimg="fill" class="object-cover" src="/assets/images/landing/hero/hero-bg.webp"
            ...
            <div class="flex flex-col-reverse items-center justify-center lg:flex-row">
                <div class="relative w-full px-0 md:ml-28 lg:ml-0 lg:w-6/12 lg:px-0">
                    <div
                        ...
                        অন্যতম বিশ্বে, এশিয়া মহাদেশে শীর্ষে</div>
                    <h1
                        ...
                        বাংলাদেশ ড্রাইভিং ট্রেনিং <br> ইনস্টিটিউট</h1>
                    <p
                    ...
                    <div class="sr-only">
                        <p>BDDTI offers comprehensive driving education with certified instructors and modern vehicles. Our
                            programs include theoretical and practical training, <a href="/driving-license">license
                                ...
                                href="/branches">branches in major cities</a>. Learn more <a href="/about-us">about our
                        ...
                        <p>Driving training at BDDTI covers essential skills such as vehicle control, traffic rules,
                            emergency procedures, and defensive driving. We provide personalized attention in small classes
                            to ensure effective learning. Our curriculum is updated regularly to reflect the latest driving
                        ...
                        <p>Students at BDDTI receive hands-on experience with various vehicle types under expert
                            ...
                            industry. Read our <a href="/blog">blog for driving tips</a> and <a href="/contact-us">contact
                ...
                <div class="relative p-4 md:w-10/12 lg:w-5/12 2xl:w-6/12">
                    <div class="relative grid grid-cols-2 gap-4 lg:gap-8">
                        <div class="relative aspect-square"><img alt="Training image" loading="eager" decoding="async"
                                data-nimg="fill" class="animated-image1 rounded-br-[62px] object-cover"
                                src="/assets/images/landing/hero/image1.webp"
                                style="position: absolute; height: 100%; width: 100%; inset: 0px; color: transparent;">
                            <div class="absolute bottom-0 left-0 -z-10 h-8 w-8 lg:h-20 lg:w-20"><img alt="Decorative shape"
                                    loading="lazy" decoding="async" data-nimg="fill" class="animated-image2"
                                    src="/assets/images/landing/hero/shape/Sape-02.webp"
                                    style="position: absolute; height: 100%; width: 100%; inset: 0px; color: transparent;">
                            </div>
                        </div>
                        <div class="relative aspect-square"><img alt="Training image" loading="eager" decoding="async"
                                data-nimg="fill" class="animated-image2 rounded-tr-[62px] object-cover"
                                src="/assets/images/landing/hero/image2.webp"
                                style="position: absolute; height: 100%; width: 100%; inset: 0px; color: transparent;">
                            <div class="absolute -right-4 -top-4 -z-10 h-20 w-20 lg:-right-16 lg:-top-14 lg:h-56 lg:w-56">
                                <img alt="Decorative shape" loading="lazy" decoding="async" data-nimg="fill"
                                    class="animated-image1" src="/assets/images/landing/hero/shape/Shape-01.webp"
                                    style="position: absolute; height: 100%; width: 100%; inset: 0px; color: transparent;">
                            </div>
                        </div>
                        <div class="relative aspect-square"><img alt="Training image" loading="eager" decoding="async"
                                data-nimg="fill" class="animated-image4 rounded-bl-[62px] object-cover"
                                src="/assets/images/landing/hero/image3.webp"
                                style="position: absolute; height: 100%; width: 100%; inset: 0px; color: transparent;">
                            <div
                                class="absolute -bottom-4 -left-1 -z-10 h-20 w-20 lg:-bottom-14 lg:-left-16 lg:h-56 lg:w-56">
                                <img alt="Decorative shape" loading="lazy" decoding="async" data-nimg="fill"
                                    class="animated-image3" src="/assets/images/landing/hero/shape/Sape-03.webp"
                                    style="position: absolute; height: 100%; width: 100%; inset: 0px; color: transparent;">
                            </div>
                        </div>
                        <div class="relative aspect-square"><img alt="Training image" loading="eager" width="300"
                                height="300" decoding="async" data-nimg="1"
                                class="animated-image3 rounded-tl-[62px] object-cover"
                                src="/assets/images/landing/hero/image4.webp" style="color: transparent;">
                            <div class="absolute right-0 top-0"><img alt="Decorative shape" loading="lazy" width="160"
                                    height="152" decoding="async" data-nimg="1"
                                    class="animated-image4 h-[38px] w-[40px] lg:h-[76px] lg:w-[80px]"
                                    src="/assets/images/landing/hero/shape/Sape-05.webp" style="color: transparent;"></div>
                        </div>
                        <div class="absolute inset-0 flex items-center justify-center">
                            <div
                                class="relative hidden h-32 w-32 items-center justify-center rounded-full bg-gray-100 lg:flex lg:h-[180px] lg:w-[180px]">
                                <div class="absolute inset-5 rounded-full bg-[#034f94]"></div>
                                <div class="absolute inset-0 flex items-center justify-center font-poppins"
                                    style="transform: rotate(253.812deg);"><span
                                        class="absolute text-xs font-bold uppercase text-black"
                                        style="transform: rotate(0deg) translate(80px) rotate(90deg);">1</span><span
                                        class="absolute text-xs font-bold uppercase text-black"
                                        style="transform: rotate(10.9091deg) translate(80px) rotate(90deg);">2</span><span
                                        class="absolute text-xs font-bold uppercase text-black"
                                        style="transform: rotate(21.8182deg) translate(80px) rotate(90deg);">+</span><span
                                        class="absolute text-xs font-bold uppercase text-black"
                                        style="transform: rotate(32.7273deg) translate(80px) rotate(90deg);"> </span><span
                                        class="absolute text-xs font-bold uppercase text-black"
                                        style="transform: rotate(43.6364deg) translate(80px) rotate(90deg);">Y</span><span
                                        class="absolute text-xs font-bold uppercase text-black"
                                        style="transform: rotate(54.5455deg) translate(80px) rotate(90deg);">e</span><span
                                        class="absolute text-xs font-bold uppercase text-black"
                                        style="transform: rotate(65.4545deg) translate(80px) rotate(90deg);">a</span><span
                                        class="absolute text-xs font-bold uppercase text-black"
                                        style="transform: rotate(76.3636deg) translate(80px) rotate(90deg);">r</span><span
                                        class="absolute text-xs font-bold uppercase text-black"
                                        style="transform: rotate(87.2727deg) translate(80px) rotate(90deg);">s</span><span
                                        class="absolute text-xs font-bold uppercase text-black"
                                        style="transform: rotate(98.1818deg) translate(80px) rotate(90deg);"> </span><span
                                        class="absolute text-xs font-bold uppercase text-black"
                                        style="transform: rotate(109.091deg) translate(80px) rotate(90deg);">o</span><span
                                        class="absolute text-xs font-bold uppercase text-black"
                                        style="transform: rotate(120deg) translate(80px) rotate(90deg);">f</span><span
                                        class="absolute text-xs font-bold uppercase text-black"
                                        style="transform: rotate(130.909deg) translate(80px) rotate(90deg);"> </span><span
                                        class="absolute text-xs font-bold uppercase text-black"
                                        style="transform: rotate(141.818deg) translate(80px) rotate(90deg);">T</span><span
                                        class="absolute text-xs font-bold uppercase text-black"
                                        style="transform: rotate(152.727deg) translate(80px) rotate(90deg);">r</span><span
                                        class="absolute text-xs font-bold uppercase text-black"
                                        style="transform: rotate(163.636deg) translate(80px) rotate(90deg);">a</span><span
                                        class="absolute text-xs font-bold uppercase text-black"
                                        style="transform: rotate(174.545deg) translate(80px) rotate(90deg);">i</span><span
                                        class="absolute text-xs font-bold uppercase text-black"
                                        style="transform: rotate(185.455deg) translate(80px) rotate(90deg);">n</span><span
                                        class="absolute text-xs font-bold uppercase text-black"
                                        style="transform: rotate(196.364deg) translate(80px) rotate(90deg);">i</span><span
                                        class="absolute text-xs font-bold uppercase text-black"
                                        style="transform: rotate(207.273deg) translate(80px) rotate(90deg);">n</span><span
                                        class="absolute text-xs font-bold uppercase text-black"
                                        style="transform: rotate(218.182deg) translate(80px) rotate(90deg);">g</span><span
                                        class="absolute text-xs font-bold uppercase text-black"
                                        style="transform: rotate(229.091deg) translate(80px) rotate(90deg);"> </span><span
                                        class="absolute text-xs font-bold uppercase text-black"
                                        style="transform: rotate(240deg) translate(80px) rotate(90deg);">E</span><span
                                        class="absolute text-xs font-bold uppercase text-black"
                                        style="transform: rotate(250.909deg) translate(80px) rotate(90deg);">x</span><span
                                        class="absolute text-xs font-bold uppercase text-black"
                                        style="transform: rotate(261.818deg) translate(80px) rotate(90deg);">c</span><span
                                        class="absolute text-xs font-bold uppercase text-black"
                                        style="transform: rotate(272.727deg) translate(80px) rotate(90deg);">e</span><span
                                        class="absolute text-xs font-bold uppercase text-black"
                                        style="transform: rotate(283.636deg) translate(80px) rotate(90deg);">l</span><span
                                        class="absolute text-xs font-bold uppercase text-black"
                                        style="transform: rotate(294.545deg) translate(80px) rotate(90deg);">l</span><span
                                        class="absolute text-xs font-bold uppercase text-black"
                                        style="transform: rotate(305.455deg) translate(80px) rotate(90deg);">e</span><span
                                        class="absolute text-xs font-bold uppercase text-black"
                                        style="transform: rotate(316.364deg) translate(80px) rotate(90deg);">n</span><span
                                        class="absolute text-xs font-bold uppercase text-black"
                                        style="transform: rotate(327.273deg) translate(80px) rotate(90deg);">c</span><span
                                        class="absolute text-xs font-bold uppercase text-black"
                                        style="transform: rotate(338.182deg) translate(80px) rotate(90deg);">e</span><span
                                        class="absolute text-xs font-bold uppercase text-black"
                                        style="transform: rotate(349.091deg) translate(80px) rotate(90deg);"> </span></div>
                                <div class="absolute inset-0 flex items-center justify-center">
                                    <div class="relative flex h-[50px] w-[50px] items-center justify-center lg:h-[92px] lg:w-[92px]"
                                        style="perspective: 1000px; transform: translateZ(30px) scale(1.1); opacity: 1; box-shadow: rgba(3, 79, 148, 0.15) 0px 8px 25px;">
                                        <div class="absolute flex items-center justify-center"
                                            style="transform: none; opacity: 1;"><img alt="playstore-qr-code image"
                                                width="82" height="82" decoding="async" data-nimg="1"
                                                class="h-[50px] w-[50px] rounded-xl object-cover shadow-lg lg:h-[92px] lg:w-[92px]"
                                                src="/qrcode.jpeg" style="color: transparent;"></div>
                                        <div class="absolute flex items-center justify-center"
                                            style="transform: rotateY(-90deg); opacity: 0;"><img alt="apple-qr-code image"
                                                width="82" height="82" decoding="async" data-nimg="1"
                                                class="h-[50px] w-[50px] rounded-xl object-cover shadow-lg lg:h-[92px] lg:w-[92px]"
                                                src="/qr-code-apple.png" style="color: transparent;"></div>
                                        <div class="absolute flex items-center justify-center"
                                            style="transform: rotateY(-90deg); opacity: 0;">
                                            <div
                                                class="flex h-[50px] w-[50px] flex-col items-center justify-center rounded-xl border border-blue-200/30 bg-gradient-to-br from-white via-blue-50 to-blue-100 shadow-xl lg:h-[92px] lg:w-[92px]">
                                                <div class="mb-1 rounded-full bg-[#034f94] p-1 lg:mb-2 lg:p-1.5"><svg
                                                        width="12" height="12" viewBox="0 0 24 24" fill="none"
                                                        class="lg:h-4 lg:w-4" aria-hidden="true">
                                                        <path d="M12 3v12m0 0l-4-4m4 4l4-4M5 21h14" stroke="white"
                                                            stroke-width="2.5" stroke-linecap="round"
                                                            stroke-linejoin="round"></path>
                                                    </svg></div><span
                                                    class="text-center text-[7px] font-extrabold leading-tight text-[#034f94] lg:text-[10px]">DOWNLOAD
                                                    BDDTI APP</span>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div
                                class="relative flex h-32 w-32 items-center justify-center rounded-full bg-gray-100 md:h-44 md:w-44 lg:hidden lg:h-44 lg:w-44">
                                <svg class="absolute inset-1 m-[-1px] md:inset-[6px] lg:m-0" viewBox="0 0 100 100"
                                    preserveAspectRatio="xMidYMid meet" aria-hidden="true">
                                    <circle cx="50" cy="50" r="49" fill="none" stroke="#034f94" stroke-width="0.3"
                                        stroke-dasharray="4 2" stroke-linecap="round"></circle>
                                </svg>
                                <div class="absolute inset-1 m-1 rounded-full bg-[#034f94] md:m-2"></div>
                                <div class="car absolute h-10 w-10 -translate-x-1/2 -translate-y-1/2 md:h-14 md:w-14 lg:h-16 lg:w-16"
                                    style="transform: rotate(103.59deg);"><img alt="Car Icon" loading="lazy" width="44"
                                        height="44" decoding="async" data-nimg="1" class="h-full w-full" src="/car.svg"
                                        style="color: transparent;"></div>
                                <div class="absolute inset-0 flex flex-col items-center justify-center">
                                    <div class="text-center font-inter text-white">
                                        <div class="static text-5xl font-extrabold md:text-7xl">12<span
                                                class="relative bottom-3 text-2xl md:text-5xl lg:text-6xl">+</span></div>
                                        <p class="text-xs font-semibold md:text-base lg:text-lg">Years of Training</p>
                                        <p class="text-xs font-semibold md:text-base lg:text-lg">Excellence</p>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <section class="bg-white dark:bg-gray-900/85" style="opacity: 1; transform: none;">
            ...
            <div class="container flex items-center justify-center px-4 py-10">
                <div class="grid grid-cols-2 gap-8 md:grid-cols-4 md:gap-4">
                    ...
                    <div
                        ...
                        <img src="/icon/Vector-3.svg" alt="Total Learners" class="h-[50px] w-[70px]">
                        <h2 class="phudu-font text-[26px] font-normal dark:text-white">55,000+</h2>
                        <h3 class="whitespace-nowrap text-center text-base text-primary dark:text-sky-400 md:text-[18px]">
                            Total Learners
                        </h3>
                    </div>
                    ...
                    <div
                        class="flex flex-col items-center border-dashed border-primary last:border-0 dark:border-gray-500 md:justify-center md:space-y-2 md:border-r md:px-24">
                        <img src="/icon/Vector-2.svg" alt="Active Students" class="h-[50px] w-[70px]">
                    ...
                    <div
                        class="flex flex-col items-center border-dashed border-primary last:border-0 dark:border-gray-500 md:justify-center md:space-y-2 md:border-r md:px-24">
                        <img src="/icon/Vector-1.svg" alt="Successful Drivers" class="h-[50px] w-[70px]">
                    ...
                    <div
                        ...
                        <img src="/icon/Vector-4.svg" alt="Branches" class="h-[50px] w-[70px]">
    ...
    <section class="bg-bg-1 px-2 dark:bg-gray-900/90">
            ...
            <div class="flex flex-col items-center gap-10 lg:flex-row">
                ...
                <div class="relative w-full lg:w-1/2">
                    <div class="relative overflow-hidden rounded-xl shadow-xl">
                        <img src="/assets/images/landing/driving-training-main.webp" alt="Driving Training"
                            class="h-full w-full object-cover">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/30 to-transparent"></div>
                    </div>

                    <!-- Experience Badge -->
                    <div class="absolute -bottom-6 -left-6 rounded-xl bg-white px-6 py-4 shadow-lg">
                        <p class="text-3xl font-extrabold text-primary">10+</p>
                        <p class="text-sm font-semibold text-gray-700">Years Experience</p>
                    </div>
                </div>
    ...
    <section class="bg-[#F7F7F7] px-2 dark:bg-gray-900/85">
        <div class="mx-auto max-w-7xl px-4 py-12 lg:py-24">
            <div class="container px-2 py-10 lg:py-24">
                <div class="flex items-center justify-center">
                    <div class="flex flex-col gap-8 lg:flex-row">
                        ...
                        <!-- Left Image Column -->
                        <div class="relative order-2 hidden w-full md:block lg:order-1 lg:w-1/2"
                            style="opacity: 1; transform: none;">
                            <div class="flex gap-2">
                                <div class="w-2/12">
                                    <img alt="experience background" loading="lazy" width="100" height="187" decoding="async"
                                        data-nimg="1"
                                        src="https://images.unsplash.com/photo-1605902711622-cfb43c4437e4?crop=entropy&cs=tinysrgb&fit=max&h=187&w=100"
                                        style="color: transparent;">
                                    <h4
                                        class="absolute -left-8 top-16 rotate-90 text-base uppercase dark:text-gray-100 md:text-2xl">
                                        15+ Years of <br> Excellence</h4>
                                </div>
                                <div class="w-10/12">
                                    <img alt="driving training" loading="lazy" width="100" height="100" decoding="async"
                                        data-nimg="1" class="w-full rounded-md"
                                        src="https://images.unsplash.com/photo-1571607384326-1b9e0c5f6782?crop=entropy&cs=tinysrgb&fit=max&h=600&w=800"
                                        style="color: transparent;">
                                </div>
                            </div>
                            <img alt="decorative image" loading="lazy" width="100" height="100" decoding="async" data-nimg="1"
                                class="animated-image3 absolute -bottom-4 left-0 w-24 md:bottom-8 md:w-64"
                                src="https://images.unsplash.com/photo-1605296867304-46d5465a13f1?crop=entropy&cs=tinysrgb&fit=max&h=267&w=256"
                                style="color: transparent;">
                        </div>
                        ...
                        <div class="order-1 w-full md:px-12 lg:order-2 lg:w-1/2 lg:px-5 xl:px-20"
                            ...
                            <h3 class="onest-font py-5 text-2xl font-semibold dark:text-gray-100 md:py-4 md:text-4xl">Shaping
                                Safe and Confident Drivers</h3>
                            <p class="text-base text-gray-600 dark:text-gray-300">
                                At <a class="font-semibold text-[#00588F] dark:text-[#0283d3]" href="/">BDDTI</a>, we focus on
                                creating skilled drivers who navigate roads safely and confidently.
                            </p>
                            <p class="text-base text-gray-600 dark:text-gray-300">
                                Our certified instructors provide personalized lessons for beginners, experienced drivers, and
                                professionals looking to enhance their driving skills.
                            </p>
                            <p class="text-base text-gray-600 dark:text-gray-300">
                                We specialize in practical driving lessons, theoretical education, and guidance through the
                                licensing process.
                            </p>
                            <p class="text-base text-gray-600 dark:text-gray-300">
                                Our structured programs combine hands-on training with comprehensive classroom instruction to
                                ensure you pass both theoretical and practical tests with confidence.
                            </p>

                            <div class="flex gap-2 py-5">
                                <img alt="training icon" loading="lazy" width="100" height="100" decoding="async" data-nimg="1"
                                    class="h-6 w-6"
                                    src="https://images.unsplash.com/photo-1600376519011-57c7c55a9d3a?crop=entropy&cs=tinysrgb&fit=max&h=50&w=50"
                                    style="color: transparent;">
                                <p class="text-base text-gray-600 dark:text-gray-400">
                                    <strong>Complete Driver Education –</strong> Covering traffic rules, defensive driving,
                                    parking, and real-world road scenarios.
                                </p>
                            </div>

                            <div class="flex gap-2 pb-8">
                                <img alt="license icon" loading="lazy" width="100" height="100" decoding="async" data-nimg="1"
                                    class="h-6 w-6 text-primary"
                                    src="https://images.unsplash.com/photo-1581091870625-2f3a4c7cb7d1?crop=entropy&cs=tinysrgb&fit=max&h=50&w=50"
                                    style="color: transparent;">
                                <p class="text-base text-gray-600 dark:text-gray-400">
                                    <strong>License Support –</strong> We simplify the driving license application process,
                                    making it smooth and stress-free.
                                </p>
                            </div>

                            <a class="cursor-pointer rounded-md bg-primary px-4 py-2 text-sm uppercase text-white transition-all duration-500 hover:bg-sky-600 dark:bg-sky-700 dark:hover:text-white md:py-3 lg:text-base"
                                href="/about-us">
                                Learn More
                            </a>
                        </div>
    ...
    <section class="bg-white pb-5 pt-5 dark:bg-gray-900/90 md:pb-10 md:pt-24">
        <div class="container mx-auto px-4">
            ...
            <p class="text-base font-light text-[#545454] dark:text-gray-300">
                We offer a range of professional driving courses to suit beginners and experienced drivers. Our structured programs ensure safe and confident driving!
            </p>
            </div>
                    ...
                    <div
                        ...
                        <div class="p-5 flex flex-col flex-grow">
                            ...
                            <a href="/courses/course-details/24">
                                <h2 class="onest-font pb-3 text-lg font-semibold hover:underline">
                ...
                <div class="w-full sm:w-6/12 lg:w-4/12 xl:w-3/12 px-3 mb-6">
                    <div
                        ...
                        <div class="p-5 flex flex-col flex-grow">
                            ...
                            <a href="/courses/course-details/25">
                                <h2 class="onest-font pb-3 text-lg font-semibold hover:underline">
                                    ইন্টারন্যাশনাল ড্রাইভিং লাইসেন্স
                ...
                <div class="w-full sm:w-6/12 lg:w-4/12 xl:w-3/12 px-3 mb-6">
                    <div
                        ...
                        <div class="p-5 flex flex-col flex-grow">
                            ...
                            <a href="/courses/course-details/26">
                                <h2 class="onest-font pb-3 text-lg font-semibold hover:underline">
...
<footer class="container">
    <div
        ...
        <p>
            © 2026 <span class="font-medium text-gray-700 dark:text-gray-200">BDDTI</span>.
            All rights reserved.
        </p>
        ...
        <div class="flex flex-wrap items-center justify-center gap-3">
            <span>
                Developed by
                <a target="_blank" href="https://softpark.xyz/"
            ...
            <a href="/terms-and-condition" class="hover:text-primary-hover">
                Terms & Conditions
            </a>

            <a href="/certificate-check" class="hover:text-primary-hover">
                Certificate Check
            </a>

            <a href="/password-reset" class="hover:text-primary-hover">
                Password Reset
            </a>
        </div>
    </div>
