                        ...
                        <tbody>
                            @foreach ($myStudents as $assignment)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('driver-student.driver-remove', $assignment->id) }}" method="POST" style="display:inline;">
                                            @csrf
                                            @method('DELETE')
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="card h-100">
                                ...
                                <div class="card-footer bg-white border-top">
                                    <form action="{{ route('driver-student.driver-select') }}" method="POST" style="display:inline;">
                                        @csrf
