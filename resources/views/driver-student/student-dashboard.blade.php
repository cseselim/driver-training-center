                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($request->status === 'pending')
                                            <form action="{{ route('driver-student.student-reject', $request->id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="card h-100">
                                ...
                                <div class="card-footer bg-white border-top">
                                    <form action="{{ route('driver-student.student-request') }}" method="POST" style="display:inline;">
                                        @csrf
